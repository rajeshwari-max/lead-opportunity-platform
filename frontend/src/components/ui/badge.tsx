...
// Per-vertical colors so each vertical is recognisable at a glance.
const verticalPalette: Record<string, string> = {
  ...
  return (
    <span
      className={cn(
        ...
        verticalPalette[vertical] ?? "bg-zinc-500/15 text-zinc-600 dark:text-zinc-400 border-zinc-500/30",
        className
      )}
      {...props}
    >
